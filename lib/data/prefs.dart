...
class Stows {
  ...
  final editorToolbarSize = PlainStow(
      'editorToolbarSize', ToolbarSize.normal,
      codec: EnumCodec(ToolbarSize.values), volatile: !_isOnMainIsolate);
  ...
  final nextcloudLogMessages = PlainStow('nextcloudLogMessages', <String>{},
      volatile: !_isOnMainIsolate);
