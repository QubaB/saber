...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsProfileEn profile = TranslationsProfileEn.internal(
    _root,
  );
  late final TranslationsAppInfoEn appInfo = TranslationsAppInfoEn.internal(
    _root,
  );
...
class TranslationsHomeEn {
  ...
  // Translations
  late final TranslationsHomeTabsEn tabs = TranslationsHomeTabsEn.internal(
    _root,
  );
...
class TranslationsSentryEn {
  ...
  // Translations
  late final TranslationsSentryConsentEn consent =
      TranslationsSentryConsentEn.internal(_root);
}
...
class TranslationsLoginEn {
  ...
  late final TranslationsLoginFormEn form = TranslationsLoginFormEn.internal(
    _root,
  );

  /// en: 'Don't have an account yet? ${linkToSignup(Sign up now)}!'
  TextSpan signup({required InlineSpanBuilder linkToSignup}) => TextSpan(
    children: [
  ...
  TextSpan notYou({required InlineSpanBuilder undoLogin}) => TextSpan(
    children: [
...
class TranslationsSentryConsentEn {
  ...
  late final TranslationsSentryConsentDescriptionEn description =
      TranslationsSentryConsentDescriptionEn.internal(_root);
  late final TranslationsSentryConsentAnswersEn answers =
      TranslationsSentryConsentAnswersEn.internal(_root);
}
...
class TranslationsSettingsPrefDescriptionsEn {
  ...
  late final TranslationsSettingsPrefDescriptionsSentryEn sentry =
      TranslationsSettingsPrefDescriptionsSentryEn.internal(_root);
}
...
class TranslationsSentryConsentDescriptionEn {
  ...
  TextSpan learnMoreInPrivacyPolicy({required InlineSpanBuilder link}) =>
      TextSpan(
        children: [
